...
#define kMinorScaleDefaultSpacing 10 // 小刻度间距
#define kMajorScaleDefaultLength 35.0 //主刻度高度
#define kMiddleScaleDefaultLength 27.0 //中间刻度高度
#define kMinorScaleDefaultLength 20.0 //小刻度高度
...
#define kIndicatorDefaultLength 50 //指示器高度
@implementation LXRulerControl
{
...
- (void)layoutSubviews {
    ...
    _indicatorView.frame = CGRectMake(size.width * 0.5,0, 1, kIndicatorDefaultLength);
    // 设置滚动视图内容间距
